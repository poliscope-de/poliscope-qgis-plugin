...
SOURCES = \
	__init__.py \
	poliscope_plugin.py poliscope_plugin_dockwidget.py

PLUGINNAME = poliscope_plugin

PY_FILES = \
	__init__.py \
	poliscope_plugin.py poliscope_plugin_dockwidget.py

UI_FILES = poliscope_plugin_dockwidget_base.ui
...
QGISDIR=C:\Users\s.wiemers.PLANGIS\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
